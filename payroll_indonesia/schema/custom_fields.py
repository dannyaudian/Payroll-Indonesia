...
class SalarySlipSchema(CustomFieldSchema):
    ...
    FIELDS = {
        "status_pajak": {
            "type": "str",
            "required": True,
            "options": ["TK0", "TK1", "TK2", "TK3", "K0", "K1", "K2", "K3", "HB0", "HB1", "HB2", "HB3"],
            "default": "TK0",
        ...
        "ter_rate": {
            "type": "float",
            "required": False,
            "description": "TER rate percentage"
        },
        ...
        "total_bpjs": {
            "type": "float",
            "required": False,
            "description": "Total BPJS deductions"
        },
        "ytd_gross_pay": {
            "type": "float",
            "required": False,
        ...
        "ytd_pph21": {
            "type": "float",
            "required": False,
            "description": "Year-to-date PPh 21 tax"
        },
        ...
        "december_tax": {
            "type": "float",
            "required": False,
            "description": "December tax amount"
        },
        "base_gross_pay": {
            "type": "float",
            "required": False,
...
class EmployeeSchema(CustomFieldSchema):
    ...
    FIELDS = {
        ...
        "golongan": {
            "type": "str",
            "required": False,
            "description": "Employee grade/rank"
        },
        "jabatan": {
            "type": "str",
            "required": False,
        ...
        "npwp_suami": {
            "type": "str",
            "required": False,
            "description": "Husband's tax ID number"
        },
        "npwp_gabung_suami": {
            "type": "bool",
            "required": False,
